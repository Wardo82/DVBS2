...
%   output, Y. Depending on the value of the InputType property, input
%   X can be an integer or bit valued vector or matrix with numeric (except
%   fi objects) and logical datatypes.
%
...
%
%   FrameLength          - Frame length supported by the DVBS2
%                          standard.
