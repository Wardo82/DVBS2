-- -------------------------------------------------------------
-- 
-- File Name: /home/wardo/Documents/DVBS2/DVBS2/src/simulink/hdl_transmitter/hdl_prj/hdlsrc/transmitter/bit_mapping.vhd
...
ARCHITECTURE rtl OF bit_mapping IS
  ...
  SIGNAL Product_out1_1                   : signed(24 DOWNTO 0);  -- sfix25_En15
  ...
  SIGNAL Product1_out1_1                  : signed(24 DOWNTO 0);  -- sfix25_En15

  ATTRIBUTE multstyle : string;

BEGIN
  u_angle_selector : angle_selector
    PORT MAP( input_sequence => input_sequence,  -- ufix1 [3]
  ...
  Product_mul_temp <= Cosine_1 * Product_cast;
  ...
  Product1_mul_temp <= Sine_1 * Product1_cast;
