...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/transmitter/6-BaseBandShaping/synthesis_reports/vivado_prj/bb_shaping_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bb_shaping.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bb_shaping.tcl
