...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/transmitter/6-BaseBandShaping/synthesis_reports/vivado_prj/bb_shaping_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bb_shaping.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bb_shaping.tcl -notrace
