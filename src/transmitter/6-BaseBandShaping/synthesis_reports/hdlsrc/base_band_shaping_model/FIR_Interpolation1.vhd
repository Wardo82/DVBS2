-- ------------------------------------------------------------
-- 
-- File Name: /home/wardo/Documents/DVBS2/DVBS2/src/transmitter/6-BaseBandShaping/synthesis_reports/hdlsrc/base_band_shaping_model/FIR_Interpolation1
-- Created: 2021-02-05 02:50:04
...
-- ------------------------------------------------------------
-- 
-- Module: FIR_Interpolation1
-- Source Path: /FIR_Interpolation1
-- 
-- ------------------------------------------------------------
-- 
...
END FIR_Interpolation1;


----------------------------------------------------------------
--Module Architecture: FIR_Interpolation1
----------------------------------------------------------------
ARCHITECTURE rtl OF FIR_Interpolation1 IS
  -- Local Functions
  -- Type Definitions
  ...
  SIGNAL FIR_Interpolation1_in_regtype    : signed(17 DOWNTO 0); -- sfix18_En14
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'event AND clk = '1' THEN
      IF phase_7 = '1' THEN
        delay_pipeline(0) <= signed(FIR_Interpolation1_in);
        delay_pipeline(1 TO 9) <= delay_pipeline(0 TO 8);
      END IF;
    END IF; 
  END PROCESS Delay_Pipeline_process;

  FIR_Interpolation1_in_regtype <= signed(FIR_Interpolation1_in);
  ...
  product_mux_10 <= coeffphase1_1 WHEN ( cur_count = to_unsigned(0, 3) ) ELSE
                         ...
                         coeffphase8_1;
  product_10 <= FIR_Interpolation1_in_regtype * product_mux_10;
  ...
  FIR_Interpolation1_out <= std_logic_vector(muxout);
END rtl;
