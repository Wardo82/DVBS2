...
HD_PWD='D:/Documents/DVBS2/DVBS2/src/transmitter/6-BaseBandShaping/xilinx_files/fil_prj/fpgaproj/bb_shaping_fil.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bb_shaping_fil.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bb_shaping_fil.tcl -notrace
