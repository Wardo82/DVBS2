...
HD_PWD='D:/Documents/DVBS2/DVBS2/src/transmitter/6-BaseBandShaping/xilinx_files/fil_prj/fpgaproj/bb_shaping_fil.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bb_shaping_fil.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bb_shaping_fil.tcl
