...
HD_PWD='D:/Documents/DVBS2/DVBS2/src/transmitter/xilinx_files/fil_prj/fpgaproj/tran_dut_fil.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tran_dut_fil.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tran_dut_fil.tcl
