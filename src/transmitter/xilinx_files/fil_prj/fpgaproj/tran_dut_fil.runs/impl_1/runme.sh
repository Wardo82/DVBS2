...
HD_PWD='D:/Documents/DVBS2/DVBS2/src/transmitter/xilinx_files/fil_prj/fpgaproj/tran_dut_fil.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tran_dut_fil.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tran_dut_fil.tcl -notrace
