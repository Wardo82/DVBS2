...
HD_PWD='D:/Documents/DVBS2/DVBS2/src/transmitter/3-FEC/ldpc/xilinx_files/fil_prj/fpgaproj/ldpc_encoder_fil.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ldpc_encoder_fil.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ldpc_encoder_fil.tcl -notrace
