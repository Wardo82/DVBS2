function parity_bits = ldpc_34_p_bits()
%ldpc_34_p_bits Returns a matrix with the partiy bits of the 3/4 ldpc
% code of the DVBS-2 standard
    parity_bits = {[0 6385 7901 14611 13389 11200 3252 5243 2504 2722 821 7374];
