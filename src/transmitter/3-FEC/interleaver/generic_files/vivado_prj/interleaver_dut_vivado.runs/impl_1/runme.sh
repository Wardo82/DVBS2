...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/transmitter/3-FEC/interleaver/generic_files/vivado_prj/interleaver_dut_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log interleaver_dut.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interleaver_dut.tcl -notrace
