...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/transmitter/3-FEC/interleaver/generic_files/vivado_prj/interleaver_dut_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interleaver_dut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interleaver_dut.tcl
