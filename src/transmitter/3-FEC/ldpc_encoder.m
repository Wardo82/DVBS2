classdef ldpc_encoder < matlab.System
    ...
    properties
        parity_bit_addresses = {[0 6385 7901 14611 13389 11200 3252 5243 2504 2722 821 7374];
    ...
    methods(Access = protected)
        ...
        function setupImpl(obj)
            ...
            obj.num_parity_bits = obj.n-obj.K; % Nldpc - Kldpc
            obj.q = 45; % Taken from table 7.a
            %     % 1.- Initialize p0 = p1 = p2 = ... = p_(nldpc−kldpc−1) = 0.
            obj.parity = zeros(1, obj.num_parity_bits);
        end
        ...
        function codeword = stepImpl(obj,message)
            ...
            for j = 0:numIter-1 % j will be each row
                parityAddrs = obj.parity_bit_addresses{j+1};
                % Iterate over all 360 information bits of a given chunk
                for i = 0:359
                    m = j*360+i;
                    adrr = mod(parityAddrs+mod(m, 360)*obj.q, obj.num_parity_bits);
                    obj.parity(adrr+1) = xor(obj.parity(adrr+1), message(m+1));
                end
            end
