...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/transmitter/3-FEC/ldpc_hdl_prj/fil_prj/fpgaproj/ldpc_encoder_fil.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ldpc_encoder_fil.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ldpc_encoder_fil.tcl
