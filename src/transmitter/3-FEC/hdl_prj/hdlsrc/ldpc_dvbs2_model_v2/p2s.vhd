-- -------------------------------------------------------------
-- 
-- File Name: D:\Documents\DVBS2\DVBS2\src\transmitter\3-FEC\hdl_prj\hdlsrc\ldpc_dvbs2_model_v2\p2s.vhd
...
ARCHITECTURE rtl OF p2s IS
  ...
  SIGNAL buffer_rsvd                      : std_logic_vector(0 TO 16199);  -- ufix1 [16200]
  ...
  SIGNAL buffer_next                      : std_logic_vector(0 TO 16199);  -- ufix1 [16200]
...
BEGIN
  ...
  p2s_1_output : PROCESS (buffer_not_empty, buffer_rsvd, counter, enable, moore_state_machine,
    ...
    VARIABLE buffer_temp : std_logic_vector(0 TO 16199);
    ...
    CASE moore_state_machine IS
      WHEN '0' =>
        ...
        IF enable = '1' THEN 
          ...
          serial_out <= buffer_temp(to_integer(sub_cast_0 - 1));
