...
set genomeRtd $env(RT_TMP)/20E5813B5B0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MATLAB_Function__GB7}]"
...
set genomeName [subst -nocommands -novariables {MATLAB_Function__GB7}]
