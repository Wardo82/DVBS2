...
set genomeRtd $env(RT_TMP)/20F07D0DED0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {logic__289_MATLAB_Function__GD}]"
...
set genomeName [subst -nocommands -novariables {logic__289_MATLAB_Function__GD}]
