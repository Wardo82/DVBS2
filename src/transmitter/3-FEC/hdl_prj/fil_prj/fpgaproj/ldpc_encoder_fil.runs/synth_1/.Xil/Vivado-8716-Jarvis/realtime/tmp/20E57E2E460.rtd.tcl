...
set genomeRtd $env(RT_TMP)/20E57E2E460.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MATLAB_Function__GB6}]"
...
set genomeName [subst -nocommands -novariables {MATLAB_Function__GB6}]
