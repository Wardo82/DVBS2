...
set genomeRtd $env(RT_TMP)/20E5853E1E0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {ldpc_encoder__GC0}]"
...
set genomeName [subst -nocommands -novariables {ldpc_encoder__GC0}]
