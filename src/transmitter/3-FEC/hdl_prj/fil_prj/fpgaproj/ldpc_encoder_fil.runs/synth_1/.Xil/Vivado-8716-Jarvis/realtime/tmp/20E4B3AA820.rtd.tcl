...
set genomeRtd $env(RT_TMP)/20E4B3AA820.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {case__904_p2s__GD}]"
...
set genomeName [subst -nocommands -novariables {case__904_p2s__GD}]
