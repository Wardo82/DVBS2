...
set genomeRtd $env(RT_TMP)/20E586C71E0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {MATLAB_Function__GB2}]"
...
set genomeName [subst -nocommands -novariables {MATLAB_Function__GB2}]
