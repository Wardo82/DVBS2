...
rt::set_parameter DFVerifyGuidedFlow {false}
...
rt::set_parameter retimingBackward {true}
rt::set_parameter retimingForward {true}
# Group: HARTPACellDelay
rt::set_parameter funnelEverestDsps {true}
rt::set_parameter funnelEverestRams {true}
rt::set_parameter funnelUserInstance {true}
rt::set_parameter speedupFunneling {true}
# Group: HARTPrepRetiming
rt::set_parameter retimingFinalDebug {true}
rt::set_parameter retimingFinalLutDiff {100}
rt::set_parameter retimingFinalRelativeDiff {500}
rt::set_parameter retimingFinalSlack {400}
rt::set_parameter retimingFinalSlackDiff {100}
...
rt::set_parameter retSkipExceptions {false}
rt::set_parameter retimingForImrreg {0}
rt::set_parameter retimingIteration {10000}
# Group: HARTRetiming
rt::set_parameter blockLeveRetimingThreshold {-1}
...
rt::set_parameter retCritEdges {false}
...
rt::set_parameter retimingVerbose {false}
rt::set_parameter retimingVersal {1}
rt::set_parameter synLocalRetiming {false}
rt::set_parameter synRetimingFast {true}
...
rt::set_parameter newNetDelayModelForEverest {true}
rt::set_parameter newNetDelayModelTestFlow {false}
rt::set_parameter oldNetDelayModel {false}
# Group: OptFSM
rt::set_parameter fsmAllowFanoutAtWireNode {true}
...
rt::set_parameter enableConstructXformForPropagatedVarExpr {true}
rt::set_parameter enableEdgeXformForLoopExitMuxes {true}
rt::set_parameter enableLoopExitMuxOptimization {true}
rt::set_parameter enableLoopExitXform1 {true}
...
rt::set_parameter convertParallelMuxToPrioMux {false}
...
rt::set_parameter datapathAdderGenMode {0}
...
rt::set_parameter datapathTunedCSA6to3Comp {false}
...
rt::set_parameter donotBalanceMuxTreeGen {true}
...
rt::set_parameter newCostFunctionForMuxPartGen {true}
...
rt::set_parameter xilinxMuxTreeGenerator {false}
# Group: gui
...
rt::set_parameter cleanupInPreMap {false}
...
rt::set_parameter dontOptimizeConvertedMuxcy {false}
...
rt::set_parameter lookBOpt {true}
rt::set_parameter lutCascadeOpt {false}
rt::set_parameter lutCombineInstantiatedCarryChainFlow {false}
...
rt::set_parameter postponeCyConversion {true}
rt::set_parameter replicateRegister {false}
rt::set_parameter retimeCtrlForSrl {false}
rt::set_parameter retimeDeltaThreshold {1200}
rt::set_parameter retimeHighFanoutThreshold {100}
rt::set_parameter retimeHighFanoutVerbose {0}
rt::set_parameter retimeInputThreshold {1200}
rt::set_parameter retimeWorstThreshold {1000}
...
rt::set_parameter constPropDram {true}
rt::set_parameter dontOptimizeXorDrivingXorCy {false}
rt::set_parameter packDspRegs {false}
rt::set_parameter skipConstPropDramForXpmMemory {true}
...
rt::set_parameter controlSetOptCollapseControlLogic {true}
...
rt::set_parameter reduceControlSetForMultiFanOutNet {false}
# Group: hartgdatapathpipeline
rt::set_parameter retimingDataPathDebug {0}
rt::set_parameter retimingDataPathForce {false}
rt::set_parameter retimingDataPathIterations {1}
rt::set_parameter retimingDataPathMark {true}
rt::set_parameter retimingLatencyDebug {false}
# Group: hartgdp
rt::set_parameter compareZeroShortCut {true}
rt::set_parameter datapathAddDisjointTimingThreshold {35}
rt::set_parameter datapathEqMaxBitsPerStage {-1}
rt::set_parameter eqConstOperandOpt {false}
rt::set_parameter eqKeepXor {false}
rt::set_parameter extendBinaryEq2Even {true}
rt::set_parameter extendLGt2Even {true}
rt::set_parameter implementMultInLogic {false}
rt::set_parameter timingDrivenGeneratorEq {false}
rt::set_parameter useOriginalCSA {false}
# Group: hartgsrlgen
rt::set_parameter retimingSRLEndMaxLength {30}
rt::set_parameter retimingSRLEndMinLength {3}
rt::set_parameter retimingSRLTotalMaxLength {34}
rt::set_parameter retimingSRLTotalMinLength {5}
# Group: harthoptpost
...
rt::set_parameter unconnectedPinToZeroForOOCTop {true}
# Group: hartlutmap
rt::set_parameter addMuxInNewPartitionForNlopt {false}
rt::set_parameter areaFlowFix2 {false}
rt::set_parameter areaPenaltyOnlyForMAPBUF3_1 {true}
rt::set_parameter decloneBrams {true}
rt::set_parameter depthConstraintForExactArea {false}
rt::set_parameter depthDrivenCarryChain {false}
rt::set_parameter depthDrivenCarryChainLoad {false}
rt::set_parameter depthFirstMapbuf31Mapping {true}
rt::set_parameter disableConstProp {true}
rt::set_parameter disableHighEffortMap {false}
rt::set_parameter enableFlatMapping {false}
rt::set_parameter forceCinToOneForBufferCy {false}
rt::set_parameter highEffortMap {false}
rt::set_parameter highEffortMapCriticalityCheck {true}
rt::set_parameter highEffortMapCriticalityCheck2 {false}
rt::set_parameter highEffortMapCriticalityCheck3 {false}
rt::set_parameter highEffortMapDampenFactor {0}
rt::set_parameter highFreqLimit {2}
...
rt::set_parameter mapBufAtConstInputGate {true}
rt::set_parameter mapperRunTimeFix {true}
rt::set_parameter maxDissolveSize {1000}
rt::set_parameter muxFMacroMap {false}
rt::set_parameter muxFMacroMapLevel {2}
rt::set_parameter newLUT6CYRecover {true}
rt::set_parameter newLUT6CYRecoverBufferOnly {false}
rt::set_parameter noRemapForMapBuf31 {true}
rt::set_parameter optCarryDi {false}
rt::set_parameter optInTryRecoverLUT6CY {false}
rt::set_parameter removeInternalLUTs {true}
rt::set_parameter setZeroArrivalForInternalCarry {true}
rt::set_parameter tieUnconnectedToZero {false}
rt::set_parameter trueFlatten {false}
rt::set_parameter tunedCascadeLUTArrival {false}
rt::set_parameter useParentCountForControlSet {true}
rt::set_parameter validateCarryLutCheckCondition6 {true}
# Group: hartndb
...
rt::set_parameter lutPairNewThreshold {false}
rt::set_parameter markGenomePinsConnectedToTopModule {true}
...
rt::set_parameter reinferPruneRegisterWithEnable {true}
...
rt::set_parameter retimingFinal {false}
rt::set_parameter retimingFinalIterations {1}
...
# Group: hartnldivmodretiming
rt::set_parameter retimingDivMod {false}
rt::set_parameter retimingDivModDebug {false}
# Group: hartnloptframework
rt::set_parameter nlOptAggrBdd {0}
rt::set_parameter nlOptAig {0}
rt::set_parameter nlOptAreaSpeed {0}
rt::set_parameter nlOptBDDOrdering {0}
rt::set_parameter nlOptComplBdd {0}
rt::set_parameter nlOptDisplayandSimulate {0}
rt::set_parameter nlOptDumpDataFromThisRunML {0}
rt::set_parameter nlOptExpt {0}
rt::set_parameter nlOptGatedClockVerbose {0}
rt::set_parameter nlOptMaxSolnsUsingSmartML {4}
rt::set_parameter nlOptOptimizeCriticalPath {0}
rt::set_parameter nlOptOptimizeCriticalPathLevel {0}
rt::set_parameter nlOptPlatForm {0}
rt::set_parameter nlOptPrintHitML {0}
rt::set_parameter nlOptRedRemoval {0}
rt::set_parameter nlOptReduceDepth {1}
rt::set_parameter nlOptRewrite {0-3-4-10000}
rt::set_parameter nlOptUseCache {1}
rt::set_parameter nlOptUseCacheML {1}
rt::set_parameter nlOptUseReadFileML {0}
rt::set_parameter nlOptUseSmartML {0}
rt::set_parameter nlOptVerilogNetlist {0}
rt::set_parameter nlOptVersalCascadeExtract {0}
rt::set_parameter nlOptWriteROM {0}
...
# Group: hartnloptutil_cxx
rt::set_parameter nlOptInputPintoMove {-1}
rt::set_parameter nlOptOutputPintoMove {0}
# Group: hartnlstandalone
rt::set_parameter nlOptLutInit {}
# Group: hartnlutil
rt::set_parameter debugConnectPins {false}
rt::set_parameter ignoreTopMapbufs {false}
rt::set_parameter isClkInvertedAttr {true}
rt::set_parameter lutPairAdjustLimit {25000}
rt::set_parameter lutPairCluster {false}
rt::set_parameter lutPairDebug {false}
rt::set_parameter lutPairNewLevel {2}
rt::set_parameter lutPairThreshold {0}
rt::set_parameter lutPairThreshold1 {600}
rt::set_parameter lutPairThresholdPercent {5}
rt::set_parameter lutPairThresholdPercent2 {10}
rt::set_parameter lutPairWorstSlack {-100}
rt::set_parameter sweepAllRegisters {true}
# Group: hartoptoperator
rt::set_parameter checkBalanceForCascadeDsrlInference {false}
rt::set_parameter checkCEPinForExtrom {true}
...
rt::set_parameter inferBitBlastedDsrl {true}
rt::set_parameter laddToRegOnly {true}
rt::set_parameter muxSetParallel {true}
rt::set_parameter removePassThroughWireAtRamEnable {true}
...
rt::set_parameter absorbInvToRegister {false}
...
rt::set_parameter bramUtilHighThresh {90.000000}
rt::set_parameter bramUtilThresh {60.000000}
rt::set_parameter breakDspCascadeLoop {true}
rt::set_parameter bromAddrThreshold {8}
rt::set_parameter bromSizeThreshold {1024}
rt::set_parameter carryBitSliceNonModFlow {false}
...
rt::set_parameter clockGatingOptimizeCombinationalLoopDetection {true}
...
rt::set_parameter clock_gating_handle_stability_latch_new {true}
...
rt::set_parameter complexDspPostInferenceFix {true}
...
rt::set_parameter controlSetOptPostMapReduceCtrlSets {false}
rt::set_parameter controlSetsOptSkipIOconnectedFlops {true}
rt::set_parameter convCmpToEq {false}
rt::set_parameter convGndToVcc {false}
rt::set_parameter convGndToVccBram {false}
rt::set_parameter convGndToVccDsp {false}
rt::set_parameter convGndToVccRegister {false}
rt::set_parameter convGndToVccUram {false}
...
rt::set_parameter datapathAddCarrySelThreshold {160}
rt::set_parameter datapathAddCheckRegLoad {false}
rt::set_parameter datapathAddTimingThreshold {11}
rt::set_parameter datapathAddTimingThresholdCLA {16}
rt::set_parameter datapathAddVersal {false}
...
rt::set_parameter datapathEqOptimizeConstantBits {false}
rt::set_parameter datapathEqTimingThreshold {8}
rt::set_parameter datapathEqUpperThreshold {288}
rt::set_parameter datapathIncThreshold {40}
rt::set_parameter datapathIncThresholdCLA {11}
...
rt::set_parameter debugNetlistDiffer {false}
rt::set_parameter debugRomColumnOpt {false}
rt::set_parameter debugSrlGen {0}
rt::set_parameter decompLargeUnaryOp {true}
rt::set_parameter decompMult {true}
rt::set_parameter decompUramForMaxTiming {false}
rt::set_parameter decompUramForOptTiming {true}
rt::set_parameter decomposeAdderForDspDotProduct {true}
rt::set_parameter decomposeHighFaninLut6 {false}
rt::set_parameter deleteLoadlessLookAhead8 {false}
...
rt::set_parameter disableEnaOptForPowerOpt {true}
...
rt::set_parameter displayFullNameInRamMessage {true}
...
rt::set_parameter doAsymURamPipeline {true}
...
rt::set_parameter dontSetDontTouch {}
...
rt::set_parameter dspCascadeLengthFromSOP {100}
rt::set_parameter dspChainDecompNaryAdder {false}
rt::set_parameter dspCheckBeforeAlignRegs {true}
rt::set_parameter dspCheckDSPStartNodeMux {true}
rt::set_parameter dspCollapseConstMult {true}
rt::set_parameter dspComplexInferCascade {true}
...
rt::set_parameter dspFixInvalidIter {2}
...
rt::set_parameter dspRelocateMRegToPReg {false}
...
rt::set_parameter dspTrackUminusDecomp {false}
...
rt::set_parameter enableNetlistDiffer {true}
rt::set_parameter enableParallelHelperSpawn {true}
rt::set_parameter enableRenamingGeneratedNetNames {true}
rt::set_parameter enableRenamingGeneratedPortNames {true}
rt::set_parameter enableRetimeMatching {false}
rt::set_parameter enableSmartLutramThreshold {true}
rt::set_parameter enableSynthDesignFanoutLimitSwitch {false}
rt::set_parameter enableSynthPlace {false}
rt::set_parameter enableUnchangedSiblingGenomeReuse {true}
rt::set_parameter enableUndoControlSetOverlap {false}
rt::set_parameter enableUndoSyncControlForAsyncReg {true}
rt::set_parameter enableUramInputPipe {true}
rt::set_parameter enableUramPipelineWithConstProp {true}
rt::set_parameter enableVersalTDRamGen {true}
...
rt::set_parameter handleMaxFanoutChange {true}
rt::set_parameter handleRetimingChangeInIncrementalSynthesis {true}
rt::set_parameter helper_shm_key {LaunchHelperProcessKey_8716_1610799952}
...
rt::set_parameter inferBramForMaxTiming {false}
rt::set_parameter inferBramForMinArea {false}
...
rt::set_parameter inferDspComplexMult {true}
...
rt::set_parameter inferInputCascadePathDspCplx {true}
rt::set_parameter inferLoadableAdd {true}
rt::set_parameter inferLogicDsp {false}
rt::set_parameter inferLut6_2 {false}
rt::set_parameter inferMixedRam {true}
rt::set_parameter inferMixedRamXpm {false}
...
rt::set_parameter inferPostSubInDspComplexMult {true}
...
rt::set_parameter inferStaticSrlUsingCascade {0}
...
rt::set_parameter keepHierForMarkDebugOnPorts {true}
...
rt::set_parameter lSFMonitorFrequency {60}
rt::set_parameter largeBRamThreshold {64}
rt::set_parameter leaveRamRegOutOfDSP {true}
...
rt::set_parameter lsfLaunchTimeout {1200}
...
rt::set_parameter mapUseEstimatedTimeForSrl {false}
rt::set_parameter mapUseEstimatedTimeForSrlLevel {1}
rt::set_parameter mapUseTimer {false}
rt::set_parameter markDebugPreservationLevel {enable}
rt::set_parameter markHighFanoutNetForRetime {false}
rt::set_parameter markInstKeepForMarkDebug {true}
rt::set_parameter markKeepHierarchyOnInsts {true}
rt::set_parameter maxAdaptFFPercent {-1}
rt::set_parameter maxBSelSelectRangeInXilinxLogicGen {16}
rt::set_parameter maxBramCascChainLength {8}
rt::set_parameter maxBramCascChainLengthTD {4}
...
rt::set_parameter maxLutramAddrSize {18}
rt::set_parameter maxLutramMemSize {262144}
...
rt::set_parameter mergeLutRam {true}
...
rt::set_parameter minInstsInControlSetPostMap {8}
...
rt::set_parameter optimizeRamModuleWithDontTouch {true}
...
rt::set_parameter packOpAtAddress {true}
rt::set_parameter packOpAtDataOut {true}
...
rt::set_parameter perfStrategy {0}
...
rt::set_parameter prioToBinaryMuxZeroAndOne {false}
rt::set_parameter processNonGenomeDependents {false}
rt::set_parameter propagateAllXpm {true}
rt::set_parameter propagateIntPortAttr {true}
...
rt::set_parameter pullLossyPreAddInDsp {true}
rt::set_parameter pullOutLastRegFromSrlInFopt {true}
rt::set_parameter pushInvAcrossFlops {true}
rt::set_parameter pushInvAllowFanoutFromQ {true}
rt::set_parameter pushInvFanoutLimit {30}
rt::set_parameter pushInvForAllFlops {false}
rt::set_parameter pushInvForceINITOnFlop {true}
rt::set_parameter pushInvOnlyCEload {true}
rt::set_parameter pushInvOnlyForLutDrivenFlop {false}
...
rt::set_parameter readLatencyCheckForXpmRomColumnOpt {true}
...
rt::set_parameter reduceCascadeLengthVariation {true}
...
rt::set_parameter reportInstantiatedPrimitives {false}
...
rt::set_parameter softKeepForMarkDebug {true}
...
rt::set_parameter traverseAllPinsOfChangedGenomes {false}
rt::set_parameter traverseAllPinsOfDependentGenomes {false}
rt::set_parameter tryFindingRegistersAcrossHierForDistRam {true}
rt::set_parameter twoPassRamFlow {true}
rt::set_parameter unconnectedMuxfPinsToZero {true}
...
rt::set_parameter unmapMixedRamForTiming {false}
...
rt::set_parameter uramMinDepthThreshold {256}
rt::set_parameter uramMinDepthThresholdNew {1024}
rt::set_parameter uramMinUtilhreshold {51}
...
rt::set_parameter uramUtilHighThresh {90.000000}
rt::set_parameter uramUtilThresh {60.000000}
rt::set_parameter uramVsBramUtilDiffThreshold {60}
...
rt::set_parameter useCarryoutInWideAdderDsp {true}
rt::set_parameter useGatesOnlyForSmallConstantInput {true}
rt::set_parameter useLogicGeneratorForInvalidOHMux {true}
rt::set_parameter useNewTDRamGen {true}
rt::set_parameter useNewUramSelection {true}
rt::set_parameter useParallelHelperForGenericLsf {true}
...
rt::set_parameter validateRetimedInputRegForExtrom {true}
rt::set_parameter verifyEarlyMaximalSharing {false}
rt::set_parameter versalAsyncRegInDsp {false}
rt::set_parameter versalBramDefaultWriteEnable {0}
rt::set_parameter versalOptimizeShallowRam {true}
...
rt::set_parameter wideXorToDspResourceLimitPerModule {35}
...
rt::set_parameter writeStatsToMetricDB {false}
...
rt::set_parameter xilinxGenerateInc {false}
...
rt::set_parameter xilinxNewSDPRam {2}
...
rt::set_parameter displayDisplay {true}
...
rt::set_parameter vlogConstantFunctions {true}
rt::set_parameter widthMismatchWarn {false}
# Group: hoptDataflow
rt::set_parameter createDFGBusGraph {false}
rt::set_parameter debugBusGraph {false}
rt::set_parameter edgeBasedBusHighlighting {false}
rt::set_parameter showCombineAndSplitNodes {true}
...
rt::set_parameter removeRedundantBmergeNodesForGenControl {true}
rt::set_parameter returnComboLoopError {true}
rt::set_parameter unShareClkDriverForGenControl {true}
# Group: hoptMerge
rt::set_parameter earlyCollapseMergeDebug {false}
rt::set_parameter earlyCollapseMergeLoop {true}
rt::set_parameter earlyCollapseMergeNestedLoop {true}
...
rt::set_parameter allowClass {true}
...
rt::set_parameter allowVirtualInterface {true}
rt::set_parameter architecture_naming_style {%s_%s}
rt::set_parameter arrayTypeForPhysicalTypes {true}
...
rt::set_parameter createPortsForNullRecords {true}
...
rt::set_parameter elabConstPropForExpressions {true}
...
rt::set_parameter elabSvlgCleanupInitialBlockBmerge {true}
rt::set_parameter elabSvlgExprEvalBasedSensitivityListCheck {true}
rt::set_parameter elabSvlgGenMapMemory {true}
rt::set_parameter elabSvlgInstantiateVhdlComplexGenericType {true}
rt::set_parameter elabSvlgInstantiateVhdlComplexPortType {true}
...
rt::set_parameter elabSvlgReuseConstFuncPortDecl {true}
rt::set_parameter elabSvlgReuseEnableDeclInsideConstFunc {true}
rt::set_parameter elabSvlgReuseFuncGraph {true}
rt::set_parameter elabSvlgReuseFuncInstance {true}
rt::set_parameter elabSvlgSupportWandWor {true}
...
rt::set_parameter elabSvlgUseDirectMultiIdxExpr {true}
rt::set_parameter elabSvlgUseDirectSelectAssign {true}
...
rt::set_parameter elabVhdlCleanupConstFuncBmerg {false}
rt::set_parameter elabVhdlCleanupConstFuncBmerge {true}
rt::set_parameter elabVhdlCleanupConstFuncInternalItems {true}
rt::set_parameter elabVhdlCleanupConstNode {true}
rt::set_parameter elabVhdlGenMapMemory {true}
rt::set_parameter elabVhdlInstantiateSvlgComplexGenericType {true}
rt::set_parameter elabVhdlInstantiateSvlgComplexPortType {true}
rt::set_parameter elabVhdlProceduralMapMemory {true}
rt::set_parameter elabVhdlPropagateAssignIdx {true}
rt::set_parameter elabVhdlReuseConstFuncPortDecl {true}
rt::set_parameter elabVhdlSeparateScopeForStmts {true}
rt::set_parameter elabVhdlUseCachedRootExpr {true}
rt::set_parameter elabVhdlUseDirectConstOperator {true}
rt::set_parameter elabVhdlUseDirectIndexedExpr {true}
rt::set_parameter elabVhdlUseDirectMultiIdxExpr {true}
rt::set_parameter elabVhdlUseDirectSelectAssign {true}
rt::set_parameter elabVhdlUseLocalScopeConstNode {true}
rt::set_parameter enableDollarRoot {false}
rt::set_parameter enableElabSystemTasks {true}
rt::set_parameter enhancedGenericsVhdl2008 {true}
...
rt::set_parameter incrementalElaboration {false}
...
rt::set_parameter loadMixedDialectVhdlPackages {false}
rt::set_parameter loadVhdl2008Libs {false}
rt::set_parameter markAsynchBmerge {true}
rt::set_parameter markModRemOperatorNodes {false}
...
rt::set_parameter newOperatorSignCalculation {true}
...
rt::set_parameter printAsLocalparam {false}
rt::set_parameter printModuleName {false}
rt::set_parameter processIntfPortsForParams {true}
rt::set_parameter processLabelForVariable {true}
...
rt::set_parameter svMarkModDivNodes {false}
...
rt::set_parameter vhdlCheckDynamicRangeMatch {false}
rt::set_parameter vhdlComplexDynamicRange {true}
rt::set_parameter vhdlConstantImpureFunction {false}
rt::set_parameter vhdlConstantStatusForGenerics {true}
rt::set_parameter vhdlDirectSelectOnlyForFunctions {true}
rt::set_parameter vhdlDynamicRange {true}
rt::set_parameter vhdlDynamicRangeDiffSizes {true}
rt::set_parameter vhdlElabCheckSliceDirection {false}
rt::set_parameter vhdlErrorUnsupportedSubprogram {true}
rt::set_parameter vhdlFixedVersion {true}
rt::set_parameter vhdlForceConstantStatus {false}
rt::set_parameter vhdlFunctionCacheing {true}
rt::set_parameter vhdlFunctionRuntimeDebug {false}
rt::set_parameter vhdlGraphFunctionCaching {true}
rt::set_parameter vhdlGraphProcedureCaching {true}
rt::set_parameter vhdlIgnoreDeclBits {false}
rt::set_parameter vhdlMarkModRemNodes {false}
rt::set_parameter vhdlResizeDynamicRangeArg {true}
rt::set_parameter vhdlResizeDynamicSignedArg {false}
rt::set_parameter vhdlSkipSelectPragmaFunctions {true}
rt::set_parameter vhdlSupportInterfaceSubprogram {true}
...
rt::set_parameter warnUnpackedUnion {false}
# Group: nl
...
rt::set_parameter collapsePrioMuxHighEffort {false}
...
rt::set_parameter includeBBoxInReportCells {true}
...
rt::set_parameter CellPlacePaddingCriteria {2147483647.000000}
...
# Group: pruneselectbits
rt::set_parameter enhancepruneSelectBits {false}
# Group: rangeOptimization
rt::set_parameter checkPowerOfTwoExpr {true}
rt::set_parameter computeAPConditionalRange {true}
rt::set_parameter computeAPRangeForDfgPatterns {true}
...
rt::set_parameter markAdderChainToSkipBitwidthOpti {true}
rt::set_parameter markShareableOpsToSkipBitwidthOpti {true}
rt::set_parameter muxChainLengthForConditionalMod {5}
rt::set_parameter optimizeBitwidthUsingWireNode {true}
rt::set_parameter optimizeBselUsingRangeset {true}
rt::set_parameter optimizeComparatorsUsingRangeset {true}
rt::set_parameter optimizeConditionalModWithMuxChain {true}
rt::set_parameter optimizeDfgSizing {true}
rt::set_parameter optimizeEqOperator {true}
rt::set_parameter optimizeNodeFromAPRangeSet {true}
rt::set_parameter optimizeNodeFromRangeSet {false}
rt::set_parameter optimizePowerOf2DivPattern {true}
rt::set_parameter optimizePowerOfTwoDiv {true}
rt::set_parameter optimizePowerOfTwoMod {true}
rt::set_parameter optimizeShiftUsingRangeset {true}
rt::set_parameter propagateConstantsForMod {true}
rt::set_parameter rangeBasedLogicOperatorOptimization {true}
...
rt::set_parameter absoluteTmpDirPath {D:/Documents/DVBS2/DVBS2/src/transmitter/3-FEC/hdl_prj/fil_prj/fpgaproj/ldpc_encoder_fil.runs/synth_1/.Xil/Vivado-8716-Jarvis}
...
rt::set_parameter aggressiveAdderCollapseForVersal {true}
rt::set_parameter aggressiveCollapseBMerges {true}
rt::set_parameter aggressiveCollapseLogicOperators {false}
...
rt::set_parameter allowCurrentInstanceInChildProc {true}
...
rt::set_parameter allowSignedInputForPruningRegisterWithEnable {false}
rt::set_parameter allowSyncRSFsm {true}
rt::set_parameter analyzeControlSetsAlwaysBlock {false}
...
rt::set_parameter callNlOptRomBeforePartitioning {false}
...
rt::set_parameter checkForStackOverflow {true}
...
rt::set_parameter cleanUpAfterRetiming {true}
...
rt::set_parameter connectUndrivenVHDL {true}
rt::set_parameter considerFsmAttrsInFirstInference {true}
...
rt::set_parameter constPropIgnoreKeepHierSoft {false}
...
rt::set_parameter createHierarchyForLoopInsideConstFunc {false}
...
rt::set_parameter createWireForUnmatchedEdges {true}
rt::set_parameter criticalRegThreshold {5}
rt::set_parameter cseBmerge {false}
rt::set_parameter cseFunctions {true}
rt::set_parameter cseNonWiredBmerge {false}
rt::set_parameter cseRuntimeFix {true}
rt::set_parameter currentInstPath {}
rt::set_parameter customModulePatternText {customArchText}
rt::set_parameter dataflowBusHighlighting {false}
rt::set_parameter dataflowHierBusHighlighting {false}
rt::set_parameter dataflowHighlighting {false}
rt::set_parameter dataflowMinBusWidth {4}
rt::set_parameter dataflowPass2BusHighlighting {false}
...
rt::set_parameter datapathAddThresholdCarry8 {6}
...
rt::set_parameter debugIncrementalNlOpt {false}
...
rt::set_parameter disableMuxOptForCasexCasez {true}
...
rt::set_parameter doEitherPolarityForMult {true}
rt::set_parameter doIncremental {false}
rt::set_parameter doRangeBasedModNodeOptimization {false}
...
rt::set_parameter dumpDFGFearturesForNloptPrediction {false}
rt::set_parameter dumpGenomesToEnableIncremental {true}
rt::set_parameter dumpMergedRegOnespinHints {false}
...
rt::set_parameter earlyCollapseMerge {true}
rt::set_parameter earlyIsolateRegSlice {false}
rt::set_parameter earlyMaximalSharing {true}
rt::set_parameter elabSvlgCreateHierarchyForGenStmt {false}
rt::set_parameter elabVhdlCreateHierarchyForGenStmt {false}
...
rt::set_parameter enableAsymRamAsyncReset {true}
...
rt::set_parameter enableInvertedDataInOperatorPushing {false}
...
rt::set_parameter fixDeepCopyDfg {true}
rt::set_parameter fixFsmFeedbackPaths {true}
rt::set_parameter fixFsmFeedbackPathsForOneHotFsm {true}
rt::set_parameter fixFsmFeedbackPathsWithReplication {true}
...
rt::set_parameter fsmOnespinHint2014Format {true}
...
rt::set_parameter genericLossyDetectionForAdders {false}
rt::set_parameter genericLsfFlow {false}
...
rt::set_parameter heuristicMarkBitSelected {false}
rt::set_parameter heuristicMarkUnbalanced {false}
...
rt::set_parameter incrementalNlOpt {true}
...
rt::set_parameter inferPatternDetectForSub {false}
...
rt::set_parameter linterFlow {false}
...
rt::set_parameter mapInitialBitToLogic {true}
rt::set_parameter mapToScan {false}
rt::set_parameter markCarrySaveForOnlyTwoInputAdder {false}
rt::set_parameter markCriticalRegisters {false}
rt::set_parameter markDebugCores {ila;vio}
rt::set_parameter markDebugOutputIlaCore {true}
rt::set_parameter markDebugPinName {probe}
rt::set_parameter markDfgFsm {true}
rt::set_parameter markDisjointAdders {false}
rt::set_parameter markDisjointAdders2InputsOnly {true}
rt::set_parameter markDisjointAddersExpanded {false}
rt::set_parameter markDisjointAddersExpanded2 {false}
rt::set_parameter markDisjointAddersFirst {true}
rt::set_parameter markDisjointAddersLast {false}
rt::set_parameter markDisjointAddersPathLimit {10000}
rt::set_parameter markDisjointAddersPrev {false}
rt::set_parameter markDisjointDatapath {false}
rt::set_parameter markSiblingModulesUnchangedInDFG {false}
rt::set_parameter markSignedDataPath {true}
...
rt::set_parameter maxNodeAreaSize {10000}
...
rt::set_parameter mergeAsyncInverters {true}
...
rt::set_parameter mergePartRuntimeFix2019_2 {true}
...
rt::set_parameter minDFPartitionAreaCount {100000}
...
rt::set_parameter multToLogicThreshold2 {10}
...
rt::set_parameter nodeDepthForVersal {true}
rt::set_parameter nonParallelRefRunReason {}
...
rt::set_parameter numPartsForLargePinModule {8}
rt::set_parameter numberOfPinsToEnableOptimizingConstruct {10}
...
rt::set_parameter operatorDirectiveCompatibility20_1 {true}
...
rt::set_parameter optimizeConditionalBitwiseAssign {false}
rt::set_parameter optimizeConstantComparisonLogic {true}
...
rt::set_parameter optimizeLoopExit {true}
...
rt::set_parameter optimizeStructuralNetlist {true}
...
rt::set_parameter preserveDirectiveInMaximalSharing {true}
...
rt::set_parameter propagateAPRangeSetThroughWireNode {true}
...
rt::set_parameter propagateRangeSetThroughWireNode {false}
...
rt::set_parameter rangesToValuesRatioToEnableOptimization {0.300000}
...
rt::set_parameter recodeConstruct {false}
...
rt::set_parameter registerBankWidthThreshold {12}
...
rt::set_parameter resourceShareForVersal {true}
...
rt::set_parameter skipGenomeReviveAndRevertToDefault {false}
...
rt::set_parameter totalBlackboxInstancesCountForIncrementalSynthesis {0}
...
rt::set_parameter transformEqCmp {false}
...
rt::set_parameter transformVariableBitSelectToMux {true}
rt::set_parameter transformVariableBitSelectToMuxThreshold {12}
...
rt::set_parameter unshareOperatorsAggressive {false}
rt::set_parameter unshareOperatorsSelective {false}
rt::set_parameter updateCellArcDelays {true}
rt::set_parameter uramResetPriorityAutoSleepFix {true}
rt::set_parameter useAPSetForRangeOptimization {1024}
...
rt::set_parameter varNodeOptimizationThreshold {0.500000}
...
rt::set_parameter writeDfgStage {}
...
rt::set_parameter writeNetlistModules {false}
...
rt::set_parameter writeXdcUsingPinOffset {true}
rt::set_parameter writeXmsg {true}
rt::set_parameter writingXdcForParallelTiming {false}
...
rt::set_parameter addBBoxPinAsInternalPin {true}
...
rt::set_parameter disableEverestCarry8Arcs {1}
...
rt::set_parameter ignoreGenomeMultiDrivers {true}
