...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/transmitter/3-FEC/bch/synthesis_reports/vivado_prj/bch_encoder_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bch_encoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bch_encoder.tcl -notrace
