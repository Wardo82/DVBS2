...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/transmitter/3-FEC/bch/synthesis_reports/vivado_prj/bch_encoder_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bch_encoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bch_encoder.tcl
