...
HD_PWD='D:/Documents/DVBS2/DVBS2/src/transmitter/3-FEC/bch/xilinx_files/fil_prj/fpgaproj/bch_encoder_fil.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bch_encoder_fil.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bch_encoder_fil.tcl -notrace
