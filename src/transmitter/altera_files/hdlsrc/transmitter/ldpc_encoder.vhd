-- -------------------------------------------------------------
-- 
-- File Name: /home/wardo/Documents/DVBS2/DVBS2/src/transmitter/altera_files/hdlsrc/transmitter/ldpc_encoder.vhd
...
ARCHITECTURE rtl OF ldpc_encoder IS
  ...
  SIGNAL slot_counter_bypass_reg          : std_logic;  -- ufix1
  ...
  SIGNAL ram_bank_out1_1                  : std_logic;
  SIGNAL ram_bank_out3_1                  : std_logic;
  SIGNAL ram_bank_out5_1                  : std_logic;
  SIGNAL ram_bank_out7_1                  : std_logic;
  SIGNAL ram_bank_out9_1                  : std_logic;
  SIGNAL ram_bank_out11_1                 : std_logic;
  SIGNAL ram_bank_out2_1                  : std_logic;
  SIGNAL global_xor_out1                  : std_logic;
  SIGNAL ram_bank_out4_1                  : std_logic;
  SIGNAL global_xor1_out1                 : std_logic;
  SIGNAL global_xor9_out1                 : std_logic;
  SIGNAL ram_bank_out6_1                  : std_logic;
  SIGNAL global_xor2_out1                 : std_logic;
  SIGNAL ram_bank_out8_1                  : std_logic;
  SIGNAL global_xor3_out1                 : std_logic;
  SIGNAL global_xor7_out1                 : std_logic;
  SIGNAL ram_bank_out10_1                 : std_logic;
  SIGNAL global_xor4_out1                 : std_logic;
  SIGNAL ram_bank_out12_1                 : std_logic;
  ...
  SIGNAL Delay1_ectrl_1                   : std_logic;  -- ufix1
  SIGNAL Delay1_lowered_bypass_reg        : std_logic;  -- ufix1
  SIGNAL Delay1_ectrl_2                   : std_logic;  -- ufix1
...
BEGIN
  ...
  Delay_reg_next(0) <= ended_flag_out1;
  ...
  slot_counter_bypass_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        slot_counter_bypass_reg <= '0';
      ELSIF enb_1_8_1 = '1' THEN
        slot_counter_bypass_reg <= start;
      END IF;
    END IF;
  END PROCESS slot_counter_bypass_process;

  
  From_out1 <= start WHEN enb_1_8_1 = '1' ELSE
      slot_counter_bypass_reg;
  ...
  ram_bank_out1_1 <= ram_bank_out1;

  ram_bank_out3_1 <= ram_bank_out3;

  ram_bank_out5_1 <= ram_bank_out5;

  ram_bank_out7_1 <= ram_bank_out7;

  ram_bank_out9_1 <= ram_bank_out9;

  ram_bank_out11_1 <= ram_bank_out11;

  ram_bank_out2_1 <= ram_bank_out2;

  global_xor_out1 <= ram_bank_out1_1 XOR ram_bank_out2_1;

  ram_bank_out4_1 <= ram_bank_out4;

  global_xor1_out1 <= ram_bank_out3_1 XOR ram_bank_out4_1;

  global_xor9_out1 <= global_xor_out1 XOR global_xor1_out1;

  ram_bank_out6_1 <= ram_bank_out6;

  global_xor2_out1 <= ram_bank_out5_1 XOR ram_bank_out6_1;

  ram_bank_out8_1 <= ram_bank_out8;

  global_xor3_out1 <= ram_bank_out7_1 XOR ram_bank_out8_1;

  global_xor7_out1 <= global_xor2_out1 XOR global_xor3_out1;

  ram_bank_out10_1 <= ram_bank_out10;

  global_xor4_out1 <= ram_bank_out9_1 XOR ram_bank_out10_1;

  ram_bank_out12_1 <= ram_bank_out12;

  global_xor5_out1 <= ram_bank_out11_1 XOR ram_bank_out12_1;
  ...
  Delay1_ectrl <= Delay1_delOut WHEN Delay_out1_1 = '0' ELSE
  ...
  Delay1_ectrl_2 <= Delay1_ectrl_1 WHEN enb_1_8_1 = '1' ELSE
      Delay1_lowered_bypass_reg;

  Delay1_delOut <= Delay1_ectrl_2;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_8_1 = '1' THEN
        Delay1_bypass_bypass_reg <= Delay1_out1_1;
      END IF;
    END IF;
  END PROCESS Delay1_bypass_bypass_process;

  
  Delay1_out1_2 <= Delay1_out1_1 WHEN enb_1_8_1 = '1' ELSE
      Delay1_bypass_bypass_reg;

  Delay1_last_value <= Delay1_out1_2;

  
  Delay1_out1 <= Delay1_last_value WHEN Delay_out1_1 = '0' ELSE
      Delay1_delOut;
