...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/transmitter/generic_files/vivado_prj/tran_dut_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tran_dut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tran_dut.tcl
