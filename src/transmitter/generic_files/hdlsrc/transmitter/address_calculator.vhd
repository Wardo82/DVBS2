-- -------------------------------------------------------------
-- 
-- File Name: /home/wardo/Documents/DVBS2/DVBS2/src/transmitter/generic_files/hdlsrc/transmitter/address_calculator.vhd
...
BEGIN
  ...
  --  step value      = 1
  --  count to value  = 359
  bit_counter1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  --  step value      = 1
  --  count to value  = 135
  slot_counter_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
