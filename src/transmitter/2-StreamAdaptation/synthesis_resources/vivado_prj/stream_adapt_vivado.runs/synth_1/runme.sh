...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/transmitter/2-StreamAdaptation/synthesis_resources/vivado_prj/stream_adapt_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_adapt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stream_adapt.tcl
