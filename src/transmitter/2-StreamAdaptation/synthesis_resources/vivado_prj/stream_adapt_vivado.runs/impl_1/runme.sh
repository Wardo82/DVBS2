...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/transmitter/2-StreamAdaptation/synthesis_resources/vivado_prj/stream_adapt_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_adapt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stream_adapt.tcl -notrace
