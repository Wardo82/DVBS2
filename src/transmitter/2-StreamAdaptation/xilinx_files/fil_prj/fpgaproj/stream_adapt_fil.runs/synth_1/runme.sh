...
HD_PWD='D:/Documents/DVBS2/DVBS2/src/transmitter/2-StreamAdaptation/xilinx_files/fil_prj/fpgaproj/stream_adapt_fil.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_adapt_fil.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stream_adapt_fil.tcl
