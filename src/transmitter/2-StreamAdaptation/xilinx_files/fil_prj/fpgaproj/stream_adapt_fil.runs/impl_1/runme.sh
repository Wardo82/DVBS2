...
HD_PWD='D:/Documents/DVBS2/DVBS2/src/transmitter/2-StreamAdaptation/xilinx_files/fil_prj/fpgaproj/stream_adapt_fil.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_adapt_fil.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stream_adapt_fil.tcl -notrace
