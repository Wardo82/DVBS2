...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/transmitter/4-Mapping/synthesis_reports/vivado_prj/bit_mapping_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_mapping.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_mapping.tcl -notrace
