...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/transmitter/4-Mapping/synthesis_reports/vivado_prj/bit_mapping_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_mapping.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_mapping.tcl
