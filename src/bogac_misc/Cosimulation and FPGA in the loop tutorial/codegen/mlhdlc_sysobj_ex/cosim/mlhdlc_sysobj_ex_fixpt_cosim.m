...
function [ref_y_out,ref_delayed_xout] = mlhdlc_sysobj_ex_fixpt_cosim(x_in,h_in1,h_in2,h_in3,h_in4)

coder.extrinsic('mlhdlc_sysobj_ex_fixpt_sysobj_cosim');
...
% Run cosimulation
[y_out,delayed_xout] = mlhdlc_sysobj_ex_fixpt_sysobj_cosim(x_in,h_in1,h_in2,h_in3,h_in4);
