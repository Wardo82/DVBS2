...
HD_PWD='/home/wardo/Documents/Matlab Projects/Cosimulation and FPGA in the loop tutorial/codegen/mlhdlc_sysobj_ex/fil/mlhdlc_sysobj_ex_fixpt_fil/fpgaproj/mlhdlc_sysobj_ex_fixpt_fil.runs/simcycle_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simcycle_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simcycle_fifo.tcl
