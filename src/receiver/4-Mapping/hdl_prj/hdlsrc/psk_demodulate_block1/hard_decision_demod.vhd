...
ARCHITECTURE rtl OF hard_decision_demod IS
  ...
  FOR ALL : value_within5
    USE ENTITY work.value_within5(rtl);
...
BEGIN
  ...
  u_value_within5 : value_within5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              lower_bound => Constant11_out1,  -- single
              value => angle,  -- single
              higher_bound => Constant12_out1,  -- single
              flag => value_within5_out1
              );

  u_value_within6 : value_within5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              lower_bound => Constant13_out1,  -- single
              value => angle,  -- single
              higher_bound => Constant14_out1,  -- single
              flag => value_within6_out1
              );

  u_value_within7 : value_within5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              lower_bound => Constant15_out1,  -- single
              value => angle,  -- single
              higher_bound => Constant16_out1,  -- single
