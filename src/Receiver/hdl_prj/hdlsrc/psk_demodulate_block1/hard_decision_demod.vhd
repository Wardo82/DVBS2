-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\psk_demodulate_block1\hard_decision_demod.vhd
...
-- Source Path: psk_demodulate_block1/HDL_DUT/hard_decision_demod
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF hard_decision_demod IS
  ...
  SIGNAL delayMatch1_reg_next             : std_logic_vector(0 TO 1);  -- ufix1_E1 [2]
  SIGNAL Gain_out1_1                      : std_logic;  -- ufix1_E1
  SIGNAL kconst                           : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL kconst_1                         : unsigned(1 DOWNTO 0);  -- ufix2
  ...
  SIGNAL value_within2_out1_1             : std_logic;
  ...
  SIGNAL delayMatch2_reg_next             : std_logic_vector(0 TO 1);  -- ufix1_E2 [2]
  SIGNAL Gain2_out1_1                     : std_logic;  -- ufix1_E2
  SIGNAL kconst_2                         : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  SIGNAL value_within_pi_out1_1           : std_logic;
  SIGNAL Gain3_out1                       : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL Gain3_out1_1                     : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL kconst_4                         : unsigned(1 DOWNTO 0);  -- ufix2_E1
  SIGNAL kconst_5                         : unsigned(1 DOWNTO 0);  -- ufix2_E1
  ...
  SIGNAL value_within5_out1_1             : std_logic;
  ...
  SIGNAL kconst_6                         : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL kconst_7                         : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  SIGNAL value_within6_out1_1             : std_logic;
  ...
  SIGNAL delayMatch3_reg_next             : std_logic_vector(0 TO 1);  -- ufix1_E3 [2]
...
BEGIN
  ...
  value_within_out1_1 <= delayMatch_reg(1);
  delayMatch_reg_next(0) <= value_within_out1;
  ...
  Gain_out1_1 <= delayMatch1_reg(1);
  delayMatch1_reg_next(0) <= Gain_out1;
  ...
  BEGIN
    IF reset_x = '1' THEN
      value_within2_out1_1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        value_within2_out1_1 <= value_within2_out1;
      END IF;
    END IF;
  ...
  Gain1_out1 <= kconst_1 WHEN value_within2_out1_1 = '1' ELSE
      to_unsigned(16#0#, 2);
  ...
  Gain2_out1_1 <= delayMatch2_reg(1);
  delayMatch2_reg_next(0) <= Gain2_out1;
  delayMatch2_reg_next(1) <= delayMatch2_reg(0);

  kconst_2 <= to_unsigned(16#5#, 3);

  HwModeRegister2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      kconst_3 <= to_unsigned(16#0#, 3);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        kconst_3 <= kconst_2;
      END IF;
  ...
  BEGIN
    IF reset_x = '1' THEN
      value_within_pi_out1_1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        value_within_pi_out1_1 <= value_within_pi_out1;
      END IF;
    END IF;
  ...
  Gain3_out1 <= kconst_3 WHEN value_within_pi_out1_1 = '1' ELSE
      to_unsigned(16#0#, 3);
  ...
  kconst_4 <= to_unsigned(16#3#, 2);

  HwModeRegister4_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      kconst_5 <= to_unsigned(16#0#, 2);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        kconst_5 <= kconst_4;
      END IF;
  ...
  BEGIN
    IF reset_x = '1' THEN
      value_within5_out1_1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        value_within5_out1_1 <= value_within5_out1;
      END IF;
    END IF;
  ...
  Gain4_in1 <= kconst_5 WHEN value_within5_out1_1 = '1' ELSE
      to_unsigned(16#0#, 2);
  ...
  kconst_6 <= to_unsigned(16#7#, 3);

  HwModeRegister6_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      kconst_7 <= to_unsigned(16#0#, 3);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        kconst_7 <= kconst_6;
      END IF;
  ...
  BEGIN
    IF reset_x = '1' THEN
      value_within6_out1_1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        value_within6_out1_1 <= value_within6_out1;
      END IF;
    END IF;
  ...
  Gain5_out1 <= kconst_7 WHEN value_within6_out1_1 = '1' ELSE
      to_unsigned(16#0#, 3);
  ...
  Gain6_out1_1 <= delayMatch3_reg(1);
  delayMatch3_reg_next(0) <= Gain6_out1;
