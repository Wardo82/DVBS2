-- -------------------------------------------------------------
-- 
-- File Name: /home/wardo/Documents/DVBS2/DVBS2/src/Receiver/4-Mapping/hdl_prj/hdlsrc/psk_demodulate_block/nfp_relop_single.vhd
...
-- Source Path: psk_demodulate_block/HDL_DUT/hard_decision_demod/value_within/nfp_relop_single
-- Hierarchy Level: 3
-- 
...
BEGIN
  ...
  Relational_Operator5_relop1_1 <= '1' WHEN Delay_out1 < Delay1_out1_1 ELSE
      '0';
  ...
  Compare_To_Constant_out1 <= '1' WHEN Delay1_out1_1 = '1' ELSE
      '0';
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay1_out1_2 <= Relational_Operator3_relop1_1;
      END IF;
    END IF;
  END PROCESS Delay1_2_process;


  Logical_Operator1_out1_1 <= Delay5_out1_2 AND Delay1_out1_2;

  Logical_Operator2_out1_3 <= Delay4_out1_2 OR Logical_Operator1_out1_1;
  ...
  Logical_Operator1_out1_2 <= Logical_Operator2_out1_1 OR Delay1_out1_3;
  ...
  Logical_Operator4_out1_3 <=  NOT Delay10_out1;

  Constant1_out1_1 <= '0';

  
  Switch4_out1 <= Logical_Operator4_out1_3 WHEN Logical_Operator1_out1_2 = '0' ELSE
      Constant1_out1_1;

  nfp_out1 <= Switch4_out1;
