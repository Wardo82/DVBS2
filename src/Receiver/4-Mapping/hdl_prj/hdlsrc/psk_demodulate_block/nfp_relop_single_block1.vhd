-- -------------------------------------------------------------
-- 
-- File Name: /home/wardo/Documents/DVBS2/DVBS2/src/Receiver/4-Mapping/hdl_prj/hdlsrc/psk_demodulate_block/nfp_relop_single_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: nfp_relop_single_block1
-- Source Path: psk_demodulate_block/HDL_DUT/hard_decision_demod/value_within_pi/nfp_relop_single
-- Hierarchy Level: 3
-- 
...
ENTITY nfp_relop_single_block1 IS
...
END nfp_relop_single_block1;


ARCHITECTURE rtl OF nfp_relop_single_block1 IS
  ...
  SIGNAL Delay5_out1_3                    : std_logic;
...
BEGIN
  ...
  Logical_Operator1_out1_1 <= Delay5_out1 AND Logical_Operator4_out1;

  Logical_Operator5_out1 <=  NOT Delay2_out1_1;

  Logical_Operator2_out1_1 <= Delay6_out1 AND Logical_Operator5_out1;

  Logical_Operator3_out1 <= Logical_Operator1_out1_1 OR Logical_Operator2_out1_1;
  ...
  Logical_Operator_out1_1 <= Logical_Operator1_out1 OR Delay1_out1;
  ...
  Logical_Operator_out1_2 <= Delay3_out1_1 AND (Delay4_out1_1 AND (Delay2_out1_1 AND Delay1_out1_1));
  ...
  Logical_Operator2_out1_2 <= Delay4_out1_2 OR Logical_Operator1_out1_2;

  Logical_Operator7_out1 <= Delay3_out1_2 AND Logical_Operator2_out1_2;
  ...
  Logical_Operator4_out1_1 <= Logical_Operator_out1_2 OR Logical_Operator6_out1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay5_out1_3 <= Logical_Operator5_out1_2;
      END IF;
    END IF;
  ...
  Switch1_out1 <= Delay5_out1_3 WHEN Logical_Operator_out1_1 = '0' ELSE
      Constant1_out1_1;
