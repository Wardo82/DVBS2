-- -------------------------------------------------------------
-- 
-- File Name: /home/wardo/Documents/DVBS2/DVBS2/src/Receiver/4-Mapping/hdl_prj/hdlsrc/psk_demodulate_block/nfp_sub_single.vhd
...
-- Source Path: psk_demodulate_block/HDL_DUT/nfp_sub_single
-- Hierarchy Level: 1
-- 
...
ARCHITECTURE rtl OF nfp_sub_single IS
  ...
  SIGNAL Delay18_reg                      : std_logic_vector(0 TO 7);  -- ufix1 [8]
  SIGNAL Delay18_reg_next                 : std_logic_vector(0 TO 7);  -- ufix1 [8]
  ...
  SIGNAL Delay2_reg_next                  : vector_of_unsigned8(0 TO 3);  -- ufix8 [4]
  ...
  SIGNAL Delay5_reg_next                  : vector_of_signed28(0 TO 1);  -- sfix28 [2]
  ...
  SIGNAL Delay6_reg_next                  : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay9_reg                       : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL Delay9_reg_next                  : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay7_reg_next                  : vector_of_unsigned27(0 TO 1);  -- ufix27 [2]
  ...
  SIGNAL Delay10_reg_next                 : std_logic_vector(0 TO 1);  -- ufix1 [2]
  ...
  SIGNAL Delay14_reg                      : std_logic_vector(0 TO 7);  -- ufix1 [8]
  SIGNAL Delay14_reg_next                 : std_logic_vector(0 TO 7);  -- ufix1 [8]
  SIGNAL Delay14_out1_1                   : std_logic;  -- ufix1
  SIGNAL alphaaSign_1_bSign_1_out1        : std_logic;  -- ufix1
  SIGNAL Delay13_reg                      : std_logic_vector(0 TO 7);  -- ufix1 [8]
  SIGNAL Delay13_reg_next                 : std_logic_vector(0 TO 7);  -- ufix1 [8]
  ...
  SIGNAL Delay15_reg_next                 : vector_of_unsigned8(0 TO 7);  -- ufix8 [8]
  ...
  SIGNAL Delay17_reg_next                 : vector_of_unsigned23(0 TO 6);  -- ufix23 [7]
...
BEGIN
  ...
  Delay18_reg_next(0) <= aExponent_cfType_Exponent_I_out1;
  ...
  Delay18_reg_next(7) <= Delay18_reg(6);
  ...
  BEGIN
    IF reset_x = '1' THEN
      Delay2_reg(0) <= to_unsigned(16#00#, 8);
      Delay2_reg(1) <= to_unsigned(16#00#, 8);
      Delay2_reg(2) <= to_unsigned(16#00#, 8);
      Delay2_reg(3) <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay2_reg_next(0) <= Delay_out1_1;
  ...
  Delay2_3_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay5_2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay5_reg(0) <= to_signed(16#0000000#, 28);
      Delay5_reg(1) <= to_signed(16#0000000#, 28);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay5_reg_next(0) <= Delay2_out1_3;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        Delay3_out1_1 <= Logical_Operator_out1_1;
      END IF;
    END IF;
  ...
  alphamant_b_ext_in0 <=  - (resize(Delay1_out1_2, 29));
  ...
  Delay_2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay_3_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay9_reg_next(0) <= BitSlice_out1;
  Delay9_reg_next(1) <= Delay9_reg(0);

  Logical_Operator_out1_2 <= exp_norm_cfType_Exponent_In_out1 AND Delay9_out1;
  ...
  BEGIN
    IF reset_x = '1' THEN
      Delay7_reg(0) <= to_unsigned(16#0000000#, 27);
      Delay7_reg(1) <= to_unsigned(16#0000000#, 27);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay7_reg_next(0) <= Delay_out1_3;
  ...
  Delay_4_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  shift_length_exp_a_cor_relop1 <= '1' WHEN Delay_out1_4 >= Bit_Slice_out1_2 ELSE
      '0';
  ...
  Delay6_2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay_5_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay_out1_5 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Delay2_4_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay2_out1_4 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Delay11_reg_next(0) <= Delay2_out1_4;
  ...
  Delay10_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay10_reg(0) <= '0';
      Delay10_reg(1) <= '0';
  ...
  Delay10_reg_next(0) <= sticky_bitget_Sum_1_out1;
  ...
  Delay_6_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay5_3_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay1_4_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay14_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay14_reg(0) <= '0';
      Delay14_reg(1) <= '0';
  ...
  Delay14_reg_next(0) <= if_bitconcat_aExponent_aMantiss_2_out1;
  Delay14_reg_next(1) <= Delay14_reg(0);
  Delay14_reg_next(2) <= Delay14_reg(1);
  Delay14_reg_next(3) <= Delay14_reg(2);
  Delay14_reg_next(4) <= Delay14_reg(3);
  Delay14_reg_next(5) <= Delay14_reg(4);
  Delay14_reg_next(6) <= Delay14_reg(5);
  Delay14_reg_next(7) <= Delay14_reg(6);

  alphaaSign_1_bSign_1_out1 <= if_bitconcat_aExponent_aMantiss_2_out1 AND if_bitconcat_aExponent_aMantiss_5_out1;

  Delay13_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay13_reg(0) <= '0';
      Delay13_reg(1) <= '0';
  ...
  Delay13_reg_next(0) <= alphaaSign_1_bSign_1_out1;
  ...
  Delay13_reg_next(6) <= Delay13_reg(5);
  Delay13_reg_next(7) <= Delay13_reg(6);

  
  if_Exponent_0_Mantissa_out1 <= Delay14_out1_1 WHEN Switch_out1_1 = '0' ELSE
      Delay13_out1_1;

  Delay6_3_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay6_out1_3 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Delay15_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
      Delay15_reg(0) <= to_unsigned(16#00#, 8);
      Delay15_reg(1) <= to_unsigned(16#00#, 8);
      Delay15_reg(2) <= to_unsigned(16#00#, 8);
      Delay15_reg(3) <= to_unsigned(16#00#, 8);
      Delay15_reg(4) <= to_unsigned(16#00#, 8);
      Delay15_reg(5) <= to_unsigned(16#00#, 8);
      Delay15_reg(6) <= to_unsigned(16#00#, 8);
      Delay15_reg(7) <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay15_reg_next(0) <= if_bitconcat_aExponent_aMantiss_out1;
  ...
  Delay7_2_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  Delay2_5_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
  ...
  BEGIN
    IF reset_x = '1' THEN
      ...
      Delay17_reg(2) <= to_unsigned(16#000000#, 23);
      Delay17_reg(3) <= to_unsigned(16#000000#, 23);
      Delay17_reg(4) <= to_unsigned(16#000000#, 23);
      Delay17_reg(5) <= to_unsigned(16#000000#, 23);
      Delay17_reg(6) <= to_unsigned(16#000000#, 23);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay17_reg_next(0) <= Delay2_out1_5;
  ...
  Delay8_1_process : PROCESS (clk, reset_x)
  BEGIN
    IF reset_x = '1' THEN
