...
HD_PWD='/home/wardo/Documents/DVBS2/DVBS2/src/Receiver/4-Mapping/hdl_prj/fil_prj/fpgaproj/HDL_DUT_fil.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDL_DUT_fil.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDL_DUT_fil.tcl
