...
HD_PWD='D:/Documents/DVBS2/DVBS2/src/Receiver/4-Mapping/hdl_prj/fil_prj/fpgaproj/HDL_DUT_fil.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HDL_DUT_fil.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDL_DUT_fil.tcl -notrace
